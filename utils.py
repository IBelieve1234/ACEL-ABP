...
def calculate_metrics(preds, targets):
    ...
    Returns:
        metrics: dict containing various metrics
    """
...
class EarlyStopping:
    ...
    def __call__(self, score):
        ...
        Returns:
            is_best: whether it is the best score
        """
...
def plot_training_curves(train_losses, val_losses, save_path):
    try:
        ...
        print("  Warning: matplotlib is not installed, cannot plot training curves")
...
def plot_predictions(preds, targets, save_path):
    try:
        ...
        print("  Warning: matplotlib is not installed, cannot plot scatter plot")
